...
import { VAPID_PUBLIC_KEY, NEXT_SERVER } from "@/utils/config";
    ...
    <ThemeProvider theme={CUSTOM_THEME}>
      <div className={styles.page}>
        <div className={styles.Dashboard}>
          ...
          <ResponsiveAppBar />
          <br />
          <DashboardGrid isEyePopupOpen={isEyePopupOpen} isWaterPopupOpen={isWaterPopupOpen} isStretchPopupOpen={isStretchPopupOpen} setIsWaterPopupOpen={setIsWaterPopupOpen} setIsEyePopupOpen={setIsEyePopupOpen} setIsStretchPopupOpen={setIsStretchPopupOpen} setIsEvolvingPopupOpen={setIsEvolvingPopupOpen} setIsChoosePetPopupOpen={setIsChoosePetPopupOpen} />
